...
import com.azure.storage.common.implementation.StructuredMessageEncoder;
import com.azure.storage.common.implementation.StructuredMessageFlags;
...
import static com.azure.storage.common.implementation.StructuredMessageEncoder.DEFAULT_SEGMENT_CONTENT_LENGTH;
import static com.azure.storage.common.implementation.StructuredMessageEncoder.STRUCTUED_BODY_TYPE;
    ...
    Mono<Response<BlockBlobItem>> uploadWithResponse(BlockBlobSimpleUploadOptions options, Context context) {
        ...
        return dataMono.flatMap(data -> {
            ...
            StructuredMessageEncoder structuredMessageEncoder = new StructuredMessageEncoder(innerBuffer, contentLength,
                DEFAULT_SEGMENT_CONTENT_LENGTH, StructuredMessageFlags.STORAGE_CRC64);
            try {
